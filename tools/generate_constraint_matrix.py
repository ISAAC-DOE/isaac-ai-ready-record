...
CODE_SCOPE = {
    ...
    "MODULATED_DESCRIPTORS_UNSPECIFIED": "all records",
    "MODULATION_DRIVEN_VARIABLE_MISSING": "all records",
    "MODULATION_RATE_OVERSPECIFIED": "all records",
    "MODULATION_EVIDENT_BUT_UNDECLARED": "all records",
